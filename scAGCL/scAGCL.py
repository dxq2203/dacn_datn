...
if __name__ == '__main__':
    ...
    # embeddings=Train(model, data, cellGraph, device, num_epochs,lam, alpha, beta, num_itersAdv, optimizer, edge_r1, edge_r2, feature_r1, feature_r2, subgraph_size, principal_components=None)
