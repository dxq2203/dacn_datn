...
#-----------------------------------------------------------------------------
def GraphAdversarialAttack(model, edge_index_1, edge_index_2, x_1, x_2, iters, node_ratio, alpha, beta, principal_components):
    ...
    for itr in range(iters):
        ...
        # Modified
        torch.nn.utils.clip_grad_norm_(S_, max_norm=0.1)
        torch.nn.utils.clip_grad_norm_(delta, max_norm=0.1)
        # Modified
